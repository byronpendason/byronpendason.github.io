...
// export default (function () {
	...
	A.Get = {
		...
		//	  azimuthInDegs: Azimuth in corrected degrees. 0Ëš N, 90Ëš E, 180Ëš S, 270Ëš W
		//	  altitude: In radians
		//	  altitudeInDegs: Altitude in degrees. 0Â° horizon, +90Â° zenith, âˆ’90Â° is nadir (down).
	...
	A.Util = {
		...
		//  Invert a degree
		// 
		//  In other words, 60Ëš becomes 240Ëš
		//
		//  Takes one argument:
	...
	A.Moon = {
		...
		/**
		 * 0:D, 1:M, 2:MÊ¹, 3:F, 4:suml, 5:sumr
		 *
		 * @const {Array} ta
		 * @static
		 */
